...
class Project extends (0, _jo.Component) {
    ...
    `;
        ...
        var controller = new _scrollmagic.Controller();
        var setMultipleClasses = (0, _gsap.TweenMax).to(btnEls, 0.5, {
            className: "show"
        });
        var scene = new _scrollmagic.Scene({
            // duration: 100,
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cdAjJ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _jo = require("../core/jo");
var _about = require("../store/about");
